...
from app.routers import accounts, analysis, auth_yahoo, gmail_labels_filters, insights, label_suggestions, maintenance, oauth_gmail, oauth_gmail_revoke
...
def create_app() -> FastAPI:
    ...
    app.include_router(gmail_labels_filters.router, prefix="/api")
    app.include_router(insights.router, prefix="/api")
    app.include_router(label_suggestions.router, prefix="/api")
    app.include_router(maintenance.router, prefix="/api")
    app.include_router(oauth_gmail.router, prefix="/api")
    app.include_router(oauth_gmail_revoke.router, prefix="/api")
