  ...
  return (
    <div style={{ marginTop: '1rem' }}>
      ...
      <p style={{ fontSize: '0.9rem', color: '#666', marginBottom: '1rem' }}>
        Custom categories are based on senders. Create categories (e.g. Finance, Urgent) and assign senders from the Top Senders list in Insights. Filter the email list by these categories in the Emails tab.
      </p>
